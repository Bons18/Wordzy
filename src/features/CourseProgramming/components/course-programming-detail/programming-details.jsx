...
export default function ProgrammingDetails({ programming }) {
  ...
  // Función para verificar si un nivel está completado (copiada del formulario)
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <span
              className={`px-2 py-1 rounded-full text-xs font-medium inline-block ${programming.estado === "Activo" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                }`}
            >
              {programming.estado}
            </span>
                ...
                <div key={level.id} className="border rounded-md">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${isLevelCompleted(level) ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                          }`}
                      >
                                    ...
                                    <div className="mt-4 border rounded-md">
                                      <div className="flex border-b">
                                        {["Actividades", "Exámenes", "Material"].map((tab) => (
                                          <button
                                            key={tab}
                                            className={`px-6 py-2 block text-sm font-medium text-gray-700 ${getActiveTab(level.id, theme.id) === tab
