...
// //                     type="date"
// //                     name="fecha"
// //                     value={formData.fecha_creacion ? format(parseISO(formData.fecha_creacion), "yyyy-MM-dd") : ""}
// //                     onChange={handleInputChange}
// //                     className="w-full px-3 py-2 border border-[#d9d9d9] rounded"
// //                   />
// //                 </div>
...
// //                   <label className="block text-sm text-[#627b87] mb-1">Fecha:</label>
// //                   <div className="px-3 py-2 border border-[#d9d9d9] rounded bg-[#f6f6fb]">
// //                     {selectedMaterial.fecha_creacion
// //                       ? new Date(selectedMaterial.fecha_creacion).toLocaleDateString()
// //                       : "Sin fecha"}
// //                   </div>
// //                 </div>
// //                 <div>
...
//                     <option value="">Seleccione un tema</option>
//                     {topics.map((topic) => (
//                       <option key={topic.id || topic._id || topic.name} value={topic.name}>
//                         {topic.name}
//                       </option>
//                     ))}
//                   </select>
